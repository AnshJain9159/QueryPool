...
function RegisterPage() {
    ...
    const handleSubmit= async (e:React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        //collect form data regsiter page se
        ...
        //validate karo koi data missing to nhi hai
  ...
  return (
    <div className="mx-auto w-full max-w-md rounded-none border border-solid border-white/30 bg-white p-4 shadow-input dark:bg-black md:rounded-2xl md:p-8 my-10">
            <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-200">
                Welcome to Query Pool
            </h2>
            <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
                Signup with Query Pool if you you don&apos;t have an account.
